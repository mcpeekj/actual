        ...
        <>
          ...
          {warnings.includes('exceeds-import-size-limit') && (
            <Block style={{ color: theme.warningText, marginTop: 15 }}>
              <Trans>
                This export is larger than $quirrel can safely re-import. You may
    ...
    >
      <Text>
        <Trans>
          ...
          imported into another $quirrel instance by closing an open file (if
          any), then clicking the "Import file" button, then choosing "$quirrel."
        </Trans>
      </Text>
      {encryptKeyId ? (
        <Text>
