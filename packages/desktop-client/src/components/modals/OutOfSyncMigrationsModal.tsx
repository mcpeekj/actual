  ...
  return (
    <Modal name="out-of-sync-migrations">
      {({ state }) => (
        <>
          <ModalHeader
            title={<ModalTitle title={t('Please update Squirrel!')} />}
          />
          <View
            style={{
              padding: 15,
          ...
          >
            <Text>
              <Paragraph style={{ fontSize: 16 }}>
                <Trans>
                  ...
                  Squirrel client. Your budget data has been updated by another
                  client, but this client is still on the old version. For the
                  best experience, please update Squirrel to the latest version.
                </Trans>
              </Paragraph>
            </Text>
            ...
            >
              <Trans>
                If you can&apos;t update Squirrel at this time you can find the
                latest release at{' '}
