...
export function ConfigServer() {
  ...
  function getErrorMessage(error: string) {
    switch (error) {
      ...
      default:
        return t(
          'Server does not look like an $quirrel server. Is it set up correctly?',
        );
    }
  }
          ...
          >
            {currentUrl ? (
              <Trans>
                ...
                server. We will validate that $quirrel is running at this URL.
              </Trans>
            ) : (
              <Trans>
                ...
                optional: $quirrel works great on just this device too.
              </Trans>
            )}
          </Text>
          {!currentUrl && (
